    ...
    <section class="mt-4">
        <div class="flex md:flex-row flex-col justify-between items-center px-4 lg:px-10">
            ...
            <div class="font1 w-full flex md:justify-end">
                <p class="bg-[#FBEABA] border-[1px] border-[#ffbe0b] rounded-[20px] w-auto h-auto p-2">Total Assignment: {{ $count }}</p>
            </div>
        </div>
        ...
        {{-- <div class="w-full h-[50px] flex items-center justify-end px-4 lg:px-10 mt-2 font1 gap-1">
            <p class="hover:text-blue-500 hover:cursor-pointer">Show More</p>
