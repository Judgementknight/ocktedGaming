...
@section('content')
<body class="h-auto w-full bg-white overflow-x-hidden">
        <x-dash-navbar />
        <x-table-tools />
        ...
        <div class="main w-full flex items-start justify-center">
            <div class="main2 w-[1200px] bg-white round border-[1px] border-black/35 relative">
                <div class="w-full h-full round bg-white absolute z-50">
                    <div class="w-full h-[80px] border-b-[1px] border-black/50 flex items-center justify-between px-5">
                        ...
                        <form action="{{route('student-details')}}" method="GET">
                            @csrf
                            <div class="w-[300px] lg:w-[500px] h-[50px] relative">
                                <div class="w-full h-full bg-white round absolute z-50 flex items-center px-2">
                                    <input name="search" placeholder="Search Player..." value="{{request('search')}}" class="border-b-[1px] w-full border-black bg-white  focus:outline-none">
                                    <div class="">
                    ...
                    <div class="w-90vw h-[64vh] round bg-white overflow-x-scroll overflow-y-scroll p-2 relative z-10 flex flex-col gap-[10px]">
                                        ...
                                        <table class="w-full kode  rounded-xl">
                                            <thead class="bg-white sticky top-0">
                                                <tr class="bg-white sticky top-0">
                                                    ...
                                                    <th scope="col" class="sticky top-0 p-5 whitespace-nowrap text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Student ID </th>
                                                    <th scope="col" class="sticky top-0p-5 whitespace-nowrap text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Student Name </th>
                                            ...
                                            <tbody class="divide-y divide-gray-300">
                                                @foreach ($players as $player )
                                                    <tr class="">
                                                        ...
                                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> {{$player->student_id}}</td>
                                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> {{$player->student_name}}</td>
                                                        ...
                                                        @if ($player->student_status === "Active") text-green-500
                                                        @else
                                                        text-red-500
                                                        @endif"> {{$player->student_status}}</td>
