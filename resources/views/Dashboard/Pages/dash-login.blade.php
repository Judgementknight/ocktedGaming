...
@section('content')
<x-toast/>
<body class="h-screen w-full flex items-center justify-center bg-white relative overflow-hidden md:px-0">
    ...
    <div class="md:w-[550px] w-[400px] h-[600px] border-[1px] border-black/50 bg-white round absolute z-20">
        ...
        <form  action="{{route('login-verify')}}" method="POST">
            ...
            <div class="h-[300px] w-full round flex flex-col gap-[47px] px-[46px]">
                <div class="h-[100px] w-full rounded-sm bggray">
                    <input name="username" class="w-full h-full bggray px-4 rounded-sm text-black" placeholder="Enter Amin Username...." type="text">
                </div>
                <div class="h-[100px] w-full rounded-sm bggray">
                    <input name="password" type="password" class="w-full h-full rounded-sm bggray px-4 text-black" placeholder="Enter Password...." type="text">
                </div>
